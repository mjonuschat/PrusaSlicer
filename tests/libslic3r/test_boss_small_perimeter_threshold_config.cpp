...
TEST_CASE("BOSS small-perimeter-threshold config options are registered", "[boss][config]")
{
    REQUIRE(has_option("small_perimeter_min_length"));
    REQUIRE(has_option("small_perimeter_max_length"));
}
