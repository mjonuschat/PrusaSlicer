...
PrintObjectConfig make_duplicate_wall_params(int min_bead_width_percent)
{
    constexpr double nozzle_diameter = 0.4;

    PrintObjectConfig print_object_config = PrintObjectConfig::defaults();
    print_object_config.min_bead_width = ConfigOptionFloatOrPercent(min_bead_width_percent, true);
    print_object_config.min_feature_size = ConfigOptionFloatOrPercent(25.0, true);
    print_object_config.wall_transition_filter_deviation = ConfigOptionFloatOrPercent(25.0, true);
    print_object_config.wall_transition_length = ConfigOptionFloatOrPercent(1.0 * nozzle_diameter, false);
    print_object_config.wall_transition_angle = ConfigOptionFloat(10.0);
    print_object_config.wall_distribution_count.setInt(1);
    return print_object_config;
}

size_t duplicate_wall_segment_count(int min_bead_width_percent)
{
    ...
    PrintConfig print_config = PrintConfig::defaults();
    ...
    Arachne::WallToolPaths wall_tool_paths(
        ...
        wall_0_inset,
        layer_height,
        make_duplicate_wall_params(min_bead_width_percent),
        print_config);
