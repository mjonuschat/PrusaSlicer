...
TEST_CASE("BOSS narrow-solid-infill-erosion config options are registered", "[boss][config]")
{
    REQUIRE(has_option("detect_narrow_solid_infill"));
    REQUIRE(has_option("detect_narrow_solid_infill_threshold"));
}
