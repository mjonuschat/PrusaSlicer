...
FaceNeighborIndex its_create_neighbors_index_1(const indexed_triangle_set &its)
{
    ...
    for (size_t face_id = 0; face_id < its.indices.size(); ++face_id) {
        const Index3d &face = its.indices[face_id];
...
std::vector<Index3d> its_create_neighbors_index_2(const indexed_triangle_set &its)
{
    std::vector<Index3d> out(its.indices.size(), Index3d(-1, -1, -1));
...
std::vector<Index3d> its_create_neighbors_index_3(const indexed_triangle_set &its)
{
    std::vector<Index3d> out(its.indices.size(), Index3d(-1, -1, -1));
...
std::vector<Index3d> its_create_neighbors_index_10(const indexed_triangle_set &its)
{
