...
SLAPrint::ApplyStatus SLAPrint::apply(const Model &model, DynamicPrintConfig config, const std::optional<Domain::ModelWipeTower>&, std::vector<std::string> *warnings)
{
#ifdef _DEBUG
