...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridge_speed", "gap_fill_speed", "gap_fill_enabled", "travel_speed", "travel_speed_z", "first_layer_speed", "first_layer_speed_over_raft", "perimeter_acceleration", "perimeter_minimum_cruise_ratio",
    "infill_acceleration", "infill_minimum_cruise_ratio", "external_perimeter_acceleration", "external_perimeter_minimum_cruise_ratio", "top_solid_infill_acceleration", "top_solid_infill_minimum_cruise_ratio",
    "solid_infill_acceleration", "solid_infill_minimum_cruise_ratio", "travel_acceleration", "travel_minimum_cruise_ratio", "bridge_acceleration", "bridge_minimum_cruise_ratio", "first_layer_acceleration",
    "first_layer_minimum_cruise_ratio", "first_layer_acceleration_over_raft", "first_layer_minimum_cruise_ratio_over_raft", "default_acceleration", "default_minimum_cruise_ratio", "wipe_tower_acceleration", "wipe_tower_minimum_cruise_ratio",
