    ...
    Polylines                       &polylines_out)
{
    ...
    // Orca: use a fixed module height (one layer) rather than the combined layer
    // thickness. With "combine infill every N layers", thickness_layers > 1 made the
    // honeycomb pattern inconsistent between Z modules and produced poor bridges.
