...
public:
    ...
    // Outer edge of the outermost skirt loop, in world coordinates. Empty if no skirt/brim was generated.
    const Domain::Points&       skirt_convex_hull() const { return m_skirt_convex_hull; }
