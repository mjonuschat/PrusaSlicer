...
inline bool has_compatible_layer_regions(const PrintRegionConfigView &config, const PrintRegionConfigView &other_config)
{
    ...
    return config.get<std::vector<int>>("perimeters").at(extruder_id)
        ...
        && config.get<std::vector<bool>>("external_perimeters_first_holes").at(extruder_id)
        == other_config.get<std::vector<bool>>("external_perimeters_first_holes").at(extruder_id)
        && config.get<double>("external_perimeters_first_holes_min_size")
        == other_config.get<double>("external_perimeters_first_holes_min_size")
        && config.get<int>("external_perimeters_first_disabled_first_layers")
        == other_config.get<int>("external_perimeters_first_disabled_first_layers")
