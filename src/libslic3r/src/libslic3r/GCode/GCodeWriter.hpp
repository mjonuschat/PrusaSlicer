...
public:
    ...
    std::string set_print_acceleration(
        unsigned int acceleration,
        double minimum_cruise_ratio    = 0.0,
        const std::string_view comment = {}
    )
    {
        return set_acceleration_internal(
            Acceleration::Print,
            acceleration,
    ...
    std::string
    set_travel_acceleration(unsigned int acceleration, double minimum_cruise_ratio = 0.0)
    {
        return set_acceleration_internal(
            Acceleration::Travel,
            acceleration,
...
private:
    ...
    std::string set_acceleration_internal(
        Acceleration type,
        unsigned int acceleration,
