...
// Validate the Domain::FullConfigFDM. Returns an empty string on success, otherwise an error message is returned.
std::string validate(const Domain::FullConfigFDM &config);
