...
public:
    ...
    //
    // Time mode
    // See: libpgcode::TimeMode
    //
    libpgcode::TimeMode time_mode() const;
    ...
    //
    libpgcode::TimeModes time_modes() const;
    //
    ...
    //
    const libpgcode::MoveVertices& vertices() const;
    //
    // Return the vertex pointed by the max value of the view visible range
    //
    const libpgcode::MoveVertex& current_vertex() const;
    //
    ...
    //
    libpgcode::GCodeExtrusionRoles extrusion_roles() const;
    //
    ...
    //
    const libpgcode::OptionTypes& options() const;
    //
