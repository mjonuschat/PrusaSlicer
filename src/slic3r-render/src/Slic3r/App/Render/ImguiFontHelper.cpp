...
static const std::vector<std::pair<const wchar_t, std::string>> FONT_ICONS = {
    ...
    { ImGui::EyeOpen                      , "eye_open"                       },
    { ImGui::EyeClosed                    , "eye_closed"                     },
    { ImGui::SolidPartVolum               , "add_part"                       },
    { ImGui::NegativeVolume               , "add_negative"                   },
    { ImGui::ModifierVolum                , "add_modifier"                   },
    { ImGui::SupportBlocker               , "support_blocker"                },
    { ImGui::SupportModifier              , "support_enforcer"               },
    { ImGui::TextSolidPartVolum           , "add_text_part"                  },
    { ImGui::TextNegativeVolume           , "add_text_negative"              },
    { ImGui::TextModifierVolum            , "add_text_modifier"              },
    { ImGui::SvgSolidPartVolum            , "svg_part"                       },
    { ImGui::SvgNegativeVolume            , "svg_negative"                   },
    { ImGui::SvgModifierVolum             , "svg_modifier"                   },
    { ImGui::ObjectIcon                   , "editor"                         },
