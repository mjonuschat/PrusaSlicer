...
PresetUpdaterVendorProfile PresetUpdaterVendorProfile::from_ini(const boost::filesystem::path &path, bool load_all)
{
    ptree tree;
    boost::nowide::ifstream ifs(path.string());
    boost::property_tree::read_ini(ifs, tree);
    return PresetUpdaterVendorProfile::from_ini(tree, path, load_all);
}
...
PresetUpdaterVendorProfile PresetUpdaterVendorProfile::from_ini(const ptree &tree, const boost::filesystem::path &path, bool load_all)
{
    ...
    PresetUpdaterVendorProfile res(id);
...
std::vector<std::string> PresetUpdaterVendorProfile::families() const
{
