...
static bool its_write_stl_ascii(const std::string& file, const std::string& label, const std::vector<stl_triangle_vertex_indices> &indices, const std::vector<stl_vertex> &vertices)
{
...
static bool its_write_stl_binary(const std::string& file, const std::string& label, const std::vector<stl_triangle_vertex_indices> &indices, const std::vector<stl_vertex> &vertices)
{
...
static tl::expected<TriangleMesh, std::string> read_stl_file(const char* input_file, bool repair)
{
    ...
    stats.open_edges = stl.stats.backwards_edges + facets_w_1_bad_edge + facets_w_2_bad_edge * 2 +
        facets_w_3_bad_edge * 3;

    stats.repaired_errors =
        {stl.stats.edges_fixed, stl.stats.degenerate_facets, stl.stats.facets_removed,
