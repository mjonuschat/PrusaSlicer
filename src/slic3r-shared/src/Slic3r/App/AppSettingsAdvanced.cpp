...
void
AppSettingsAdvanced::toggle_favorite_preset(const std::string& id, const std::string& hw_config_id)
{
...
{
    json_value = {{"printer_favorite_presets", app_settings_advanced.printer_favorite_presets}};
}
