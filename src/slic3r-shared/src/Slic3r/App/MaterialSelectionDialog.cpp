...
MaterialSelectionDialog::MaterialSelectionDialog(Biz::ProjectInteractor& project_interactor) :
    ...
    m_filament_settings_dialog(project_interactor)
{
    ...
    m_advanced_button->callbacks().checked_changed = [this](bool checked) {
        if (checked) {
    ...
    m_filament_settings_dialog.attach_to_item(content_item(), Position::Left);
...
void MaterialSelectionDialog::on_will_be_reset()
{
    ...
    m_material_index = Domain::INVALID_ID;
