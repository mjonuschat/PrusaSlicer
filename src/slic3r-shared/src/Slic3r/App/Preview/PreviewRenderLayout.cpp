...
void PreviewRenderLayout::init_right_sizer()
{
    ...
    add_item(sidebar_sizer, m_cb_sidebar_auto_reslice_render, "auto re-slice", Yoga::Margins(20.f, 20.f));
    add_item(sidebar_sizer, m_cb_sidebar_after_slice_render, "after slice", Yoga::Margins(20.f, 20.f));
