...
static void draw_items_detail(Render::ImguiRender& imgui_render, Viewer& viewer, WrapperImpl& wrapper, const LegendCallbacks& cbs)
{
    ...
    switch (type)
    {
    case ViewType::FeatureType:              { draw_feature_type_items_detail(imgui_render, viewer, wrapper, cbs); break;}
    case ViewType::Height:
    case ViewType::Width:
    case ViewType::ActualSpeed:
    case ViewType::Speed:
    ...
    case ViewType::ColorPrint:               { draw_color_print_items_detail(imgui_render, viewer, wrapper, cbs.cb_request_extra_frame); break; }
    default:                                 { break; }
    }
}
