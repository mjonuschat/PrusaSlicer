...
void PlaterRenderLayout::init_left_sizer()
{
    ...
    add_panel(left_sizer, m_cb_history_render, "history");
...
void PlaterRenderLayout::init_right_sizer()
{
    ...
    add_panel(right_sizer, m_cb_sidebar_bed_render, "bed_settings");
    add_panel(right_sizer, m_cb_sidebar_print_render, "print_settings");
    add_panel(right_sizer, m_cb_sidebar_slice_render, "slice", { 20.f, 20.f });
}
