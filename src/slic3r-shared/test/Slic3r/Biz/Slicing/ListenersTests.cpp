...
using Slic3r::Biz::Slicing::ISlicingWipeTowerGeometryListener;
...
struct WipeTowerGeometryListener : public ISlicingWipeTowerGeometryListener
{
...
TEST_CASE("Background process dispatches wipe_tower_geometry once available", "[slicing][slicing-callbacks]")
{
    ...
    slicing.add_wipe_tower_geometry_listener(&wipe_tower_geometry_listener);
