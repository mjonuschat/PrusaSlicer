...
{
public:
    explicit MultiMaterialPaintingDialog(const std::vector<Domain::ColorRGBA>& painting_colors);
...
private:
    ...
    Yoga::Passthrough<Yoga::SliderWithInput> m_bucket_fill_angle_slider;
    Yoga::Passthrough<Yoga::SliderWithInput> m_height_range_slider;
