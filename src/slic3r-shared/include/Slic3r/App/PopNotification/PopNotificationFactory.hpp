...
public:
    ...
    static PopNotificationDataPtr create_custom(
    ...
    static PopNotificationDataPtr create_custom_with_header(
        PopNotificationLevel level,
        int duration_seconds,
        const std::string& text,
    ...
    static PopNotificationDataPtr create_button_test()
    {
        ...
        return std::make_unique<PopNotificationData>(
            ...
            PopNotificationLayoutHeaderTextButtons(
                "This must be important right?",
                "First button will close this notification.",
                std::move(buttons)
            )
        );
    }
    ...
    static PopNotificationDataPtr create_progress_test()
    {
        return std::make_unique<PopNotificationData>(
            ...
            PopNotificationLayoutTextProgress("Progress bar:", 25)
        );
    }
    ...
    static PopNotificationDataPtr create_job_notification(
        const std::string& text,
        const std::string& job_name,
        const Slic3r::Biz::Platform::JobManager::Progress& progress
    )
    {
        return std::make_unique<PopNotificationData>(
            s_next_id++,
    ...
    static PopNotificationDataPtr create_slicing_notification(
        const std::string& text,
        const Biz::Slicing::Status& status,
