...
public:
    ...
    static std::string cooling_description(const Domain::ConfigPack& preset);
    ...
    static std::string maximum_volumetric_flow_description(const Domain::ConfigPack& preset, int idx_extruder = 0);
    ...
    static std::string recommended_thin_wall_thickness(const Domain::ConfigPack& preset);
    ...
    static std::string top_bottom_shell_thickness_explanation(const Domain::ConfigPack& preset);
};
