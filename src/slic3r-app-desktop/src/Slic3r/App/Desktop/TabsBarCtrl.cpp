...
TabsBarCtrl::ButtonWithPopup::ButtonWithPopup(wxWindow* parent, const wxString& label, const std::string& icon_name, const int px_cnt, const int orient, wxSize size)
...
TabsBarCtrl::ButtonWithPopup::ButtonWithPopup(wxWindow* parent, const std::string& icon_name, const int orient, int icon_width/* = 20*/, int icon_height/* = 20*/)
...
bool TabsBarCtrl::InsertPage(size_t n, const wxString& text, bool bSelect/* = false*/, const std::string& bmp_name/* = ""*/)
{
    ...
    m_buttons_sizer->Insert(n, new wxSizerItem(btn, 0, m_orient == wxVERTICAL ? wxALIGN_CENTER_HORIZONTAL : wxALIGN_CENTER_VERTICAL));
