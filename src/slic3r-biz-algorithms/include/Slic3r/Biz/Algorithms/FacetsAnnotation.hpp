...
indexed_triangle_set get_facets(const Domain::FacetsAnnotation &facets_annotation, const ModelVolume &model_volume, Domain::TriangleSelector::TriangleStateType type);
indexed_triangle_set get_facets_strict(const Domain::FacetsAnnotation &facets_annotation, const ModelVolume &model_volume, Domain::TriangleSelector::TriangleStateType type);
