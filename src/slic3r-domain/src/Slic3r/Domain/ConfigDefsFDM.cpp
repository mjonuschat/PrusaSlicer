...
// Defs from void PrintConfigDef::init_fff_params() follow:
    ...
    * It is part of s_project_options...
    ...
    def->choices = {
        ...
        { std::string("ABS-CF"),     std::string("ABS-CF")     },
        { std::string("ABS-GF"),     std::string("ABS-GF")     },
        { std::string("ASA"),        std::string("ASA")        },
        { std::string("ASA-Aero"),   std::string("ASA-Aero")   },
        { std::string("ASA-CF"),     std::string("ASA-CF")     },
        { std::string("ASA-GF"),     std::string("ASA-GF")     },
        { std::string("BVOH"),       std::string("BVOH")       },
        { std::string("CPE"),        std::string("CPE")        },
        { std::string("EDGE"),       std::string("EDGE")       },
        { std::string("EVA"),        std::string("EVA")        },
        { std::string("FLEX"),       std::string("FLEX")       },
        { std::string("HIPS"),       std::string("HIPS")       },
        { std::string("HTPET"),      std::string("HTPET")      },
        { std::string("LW-PLA"),     std::string("LW-PLA")     },
        { std::string("NGEN"),       std::string("NGEN")       },
        { std::string("NYLON"),      std::string("NYLON")      },
        { std::string("PA"),         std::string("PA")         },
        { std::string("PA-CF"),      std::string("PA-CF")      },
        { std::string("PA-GF"),      std::string("PA-GF")      },
        { std::string("PA11-CF"),    std::string("PA11-CF")    },
        { std::string("PA6-CF"),     std::string("PA6-CF")     },
        { std::string("PA6-GF"),     std::string("PA6-GF")     },
        { std::string("PC"),         std::string("PC")         },
        { std::string("PC-ABS"),     std::string("PC-ABS")     },
        { std::string("PC-CF"),      std::string("PC-CF")      },
        { std::string("PC-GF"),      std::string("PC-GF")      },
        { std::string("PC-PBT"),     std::string("PC-PBT")     },
        { std::string("PC-PBT-CF"),  std::string("PC-PBT-CF")  },
        { std::string("PC-PBT-GF"),  std::string("PC-PBT-GF")  },
        { std::string("PC-SI"),      std::string("PC-SI")      },
        { std::string("PCTG"),       std::string("PCTG")       },
        { std::string("PE"),         std::string("PE")         },
        { std::string("PE-CF"),      std::string("PE-CF")      },
        { std::string("PEEK"),       std::string("PEEK")       },
        { std::string("PEI"),        std::string("PEI")        },
        { std::string("PEKK"),       std::string("PEKK")       },
        { std::string("PET"),        std::string("PET")        },
        { std::string("PET-CF"),     std::string("PET-CF")     },
        { std::string("PETG"),       std::string("PETG")       },
        { std::string("PETG-CF"),    std::string("PETG-CF")    },
        { std::string("PETG-CF10"),  std::string("PETG-CF10")  },
        { std::string("PETG-GF"),    std::string("PETG-GF")    },
        { std::string("PHA"),        std::string("PHA")        },
        { std::string("PLA"),        std::string("PLA")        },
        { std::string("PLA-AERO"),   std::string("PLA-AERO")   },
        { std::string("PLA-CF"),     std::string("PLA-CF")     },
        { std::string("PLA-GF"),     std::string("PLA-GF")     },
        { std::string("PMMA"),       std::string("PMMA")       },
        { std::string("POM"),        std::string("POM")        },
        { std::string("PP"),         std::string("PP")         },
        { std::string("PP-CF"),      std::string("PP-CF")      },
        { std::string("PP-GF"),      std::string("PP-GF")      },
        { std::string("PPA-CF"),     std::string("PPA-CF")     },
        { std::string("PPA-GF"),     std::string("PPA-GF")     },
        { std::string("PPS"),        std::string("PPS")        },
        { std::string("PPS-CF"),     std::string("PPS-CF")     },
        { std::string("PSU"),        std::string("PSU")        },
        { std::string("PVA"),        std::string("PVA")        },
        { std::string("PVB"),        std::string("PVB")        },
        { std::string("PVDF"),       std::string("PVDF")       },
        { std::string("SBS"),        std::string("SBS")        },
        { std::string("SCAFF"),      std::string("SCAFF")      },
        { std::string("TPE"),        std::string("TPE")        },
        { std::string("TPU"),        std::string("TPU")        },
    };
