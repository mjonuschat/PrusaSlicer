...
CAPABILITY_REGISTRIES = {
    ...
    "perimeter_geometry": {
        "target": "libslic3r",
        "alias": "BossPerimeterGeometryFeatures",
        "template": "Slic3r::Boss::BossPerimeterGeometryRegistry",
        "template_header": "boss/foundation/BossPerimeterGeometryRegistry.hpp",
