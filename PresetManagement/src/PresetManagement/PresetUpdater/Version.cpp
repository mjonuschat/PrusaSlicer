...
#include "../../Utils/FileParserError.hpp"
...
Slic3r::Semver Index::version() const
{
...
Index::const_iterator Index::find(const Slic3r::Semver &ver) const
{ 
	Version key;
...
Index::const_iterator Index::recommended(const Slic3r::Semver &slic3r_version) const
{
