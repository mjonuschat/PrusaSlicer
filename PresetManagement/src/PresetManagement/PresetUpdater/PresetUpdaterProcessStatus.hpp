#ifndef slic3r_PresetUpdaterProcessStatus_hpp_
#define slic3r_PresetUpdaterProcessStatus_hpp_
...
public:
    ...
    Slic3r::HttpRetryOpt get_retry_policy() const { return m_retry_policy; }
...
private:
    ...
    Slic3r::HttpRetryOpt m_retry_policy;
    static const std::map<PresetUpdaterProcessStatus::PresetUpdaterRetryPolicy, Slic3r::HttpRetryOpt> policy_map;
...
#endif // slic3r_PresetManagmentProcessStatus_hpp_