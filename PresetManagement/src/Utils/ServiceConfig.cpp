...
ServiceConfig::ServiceConfig()
    : m_connect_url("https://dev.connect.prusa3d.com")
    , m_account_url("https://test-account.prusa3d.com")
    , m_account_client_id("UfTRUm5QjWwaQEGpWQBHGHO3reAyuzgOdBaiqO52")
    , m_media_url("https://test-media.printables.com")
    , m_preset_repo_url("https://preset-repo-api.prusa3d.com") 
    , m_printables_url("https://test.printables.com")
{
