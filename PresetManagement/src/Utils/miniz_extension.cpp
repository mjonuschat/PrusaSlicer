...
std::string MZ_Archive::get_errorstr(mz_zip_error mz_err)
{
    ...
    case MZ_ZIP_TOO_MANY_FILES:
        return std::string("too many files");
    case MZ_ZIP_FILE_TOO_LARGE:
        return std::string("file too large");
    case MZ_ZIP_UNSUPPORTED_METHOD:
        return std::string("unsupported method");
    case MZ_ZIP_UNSUPPORTED_ENCRYPTION:
        return std::string("unsupported encryption");
    case MZ_ZIP_UNSUPPORTED_FEATURE:
        return std::string("unsupported feature");
    case MZ_ZIP_FAILED_FINDING_CENTRAL_DIR:
        return std::string("failed finding central directory");
    case MZ_ZIP_NOT_AN_ARCHIVE:
        return std::string("not a ZIP archive");
    case MZ_ZIP_INVALID_HEADER_OR_CORRUPTED:
        return std::string("invalid header or archive is corrupted");
    case MZ_ZIP_UNSUPPORTED_MULTIDISK:
        return std::string("unsupported multidisk archive");
    case MZ_ZIP_DECOMPRESSION_FAILED:
        return std::string("decompression failed or archive is corrupted");
    case MZ_ZIP_COMPRESSION_FAILED:
        return std::string("compression failed");
    case MZ_ZIP_UNEXPECTED_DECOMPRESSED_SIZE:
        return std::string("unexpected decompressed size");
    case MZ_ZIP_CRC_CHECK_FAILED:
        return std::string("CRC-32 check failed");
    case MZ_ZIP_UNSUPPORTED_CDIR_SIZE:
        return std::string("unsupported central directory size");
    case MZ_ZIP_ALLOC_FAILED:
        return std::string("allocation failed");
    case MZ_ZIP_FILE_OPEN_FAILED:
        return std::string("file open failed");
    case MZ_ZIP_FILE_CREATE_FAILED:
        return std::string("file create failed");
    case MZ_ZIP_FILE_WRITE_FAILED:
        return std::string("file write failed");
    case MZ_ZIP_FILE_READ_FAILED:
        return std::string("file read failed");
    case MZ_ZIP_FILE_CLOSE_FAILED:
        return std::string("file close failed");
    case MZ_ZIP_FILE_SEEK_FAILED:
        return std::string("file seek failed");
    case MZ_ZIP_FILE_STAT_FAILED:
        return std::string("file stat failed");
    case MZ_ZIP_INVALID_PARAMETER:
        return std::string("invalid parameter");
    case MZ_ZIP_INVALID_FILENAME:
        return std::string("invalid filename");
    ...
    case MZ_ZIP_ARCHIVE_TOO_LARGE:
        return std::string("archive is too large");
    case MZ_ZIP_VALIDATION_FAILED:
        return std::string("validation failed");
    case MZ_ZIP_WRITE_CALLBACK_FAILED:
        return std::string("write calledback failed");
    default:
        break;
    }
